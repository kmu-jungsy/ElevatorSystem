...
from Check.System.Cabinet import Cabinet
from Check.System.GlobalState import State 
from Check.System.StandardStrategy import StandardStrategy
import secrets

class SystemManager:
    def __init__(self, numberOfCabinets, numberOfFloors):
        if numberOfCabinets < 1: 
            raise Exception("Need at least 1 cabinet")
        if numberOfFloors < 1:
            raise Exception("Need at least 1 floor to use this system")
